...
$(function() {
    $('body').terminal({
        ...
        help: function() {
            ...
            this.echo('open [value] - lets you open any file inside your current folder:' + directory + '.');
        ...
        greetings: 'welcome to the [[b;#65995F;black]sushiwt terminal]! [Version 1.1.7] \n(uses jqueryterminal (https://terminal.jcubic.pl/)) \n',
